...
export const APPLY_JOB = 'job/APPLY_JOB';
export const APPLY_JOB_SUCCESS = 'job/APPLY_JOB_SUCCESS';
...
export const applyJob = (jobId: string, userId: string, toEmail: string) => action(APPLY_JOB, { jobId, userId, toEmail });
export const applyJobSuccess = (data: any) => action(APPLY_JOB_SUCCESS, {data});
